...
@section('content')
    ...
    <div class="container mx-auto mt-20 sm:mt-22">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 ">
            <div class="card shadow-lg rounded-xl overflow-hidden bg-white transition-transform duration-300 hover:scale-105">
                ...
                <div class="card-body p-4">
                    ...
                    <button
                        class="bg-gray-800 text-white px-4 py-2 rounded-lg mt-2 hover:bg-gray-300 transition duration-300 ease-in-out">View
                        Details</button>
                </div>
            </div>
            <div class="card shadow-lg rounded-xl overflow-hidden bg-white transition-transform duration-300 hover:scale-105">
