        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-white drop-shadow-xl">
            ...
            <div class="pt-4 ml-6">
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a wire:navigate href="/pengumuman-manager" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
