    ...
    <main class="p-4 sm:ml-64 font-poppins">
        <div class="bg-white p-6 rounded-md shadow-md">
            <form wire:submit.prevent="update">
                ...
                <div class="mt-3">
                    <label for="additionalImages" class="block mb-2 text-sm font-medium text-gray-900">Foto Tambahan (Maksimal 4)</label>
                    <input wire:model="additionalImages" type="file" id="additionalImagesInput" class="hidden" accept="image/*" multiple />
                    <label for="additionalImagesInput" id="additionalImagesLabel" class="cursor-pointer flex flex-col items-center">
                    ...
                    <div id="additionalImagesPreviewContainer" class="mt-4 flex flex-wrap gap-2">
                        ...
                        @foreach($existingAdditionalImages as $image)
                            <div class="relative">
                                ...
                                <button wire:click="removeExistingImage({{ $image->id }})" class="absolute top-0 right-0 bg-red-500 text-white rounded-full p-1">
                                    X
                                </button>
                            </div>
                        @endforeach
