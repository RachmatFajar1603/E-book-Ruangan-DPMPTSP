    ...
    <main class="p-4 sm:ml-64">
        <div class="grid grid-cols-4 space-y-8">
            <div class="w-fit bg-white p-4 shadow rounded-lg mt-8">
                <img src="images/logo-dmptsp.png" alt="" class="w-80 h-72 object-contain">
                ...
                <div class="flex justify-beetween space-x-8 p-2 my-2 text-xs">
                ...
                <div class="flex justify-center space-x-2">
                    <a href="data-ruangan-pinjam" type="button" class="flex justify-center items-center w-1/2 h-16 text-white bg-blue-500 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Pinjam<br>Sekarang
                    </a>                
                ...
                <div class="p-2">
                    ...
                    <span class="text-gray-500">0x</span>
