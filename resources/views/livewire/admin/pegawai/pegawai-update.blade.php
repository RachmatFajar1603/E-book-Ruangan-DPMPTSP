        ...
        <div class="bg-white p-6 w-1/2 shadow-md rounded-lg mx-auto">
            ...
            <form wire:submit.prevent='update'>
                <div class="mb-5">
                    ...
                    <input wire:model="nip" type="text" id="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>
                <div class="mb-5">
