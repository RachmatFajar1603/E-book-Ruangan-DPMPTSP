    ...
    <main class="p-4 sm:ml-64 grid grid-cols-3 space-x-8 font-poppins">
        <div class="bg-white col-span-2 p-8 text-center rounded-lg shadow">
            <p class="text-2xl text-blue-400">
                Edit Peminjaman - {{ $ruangan ? $ruangan->nama : 'Ruangan tidak tersedia' }}
            </p>
            ...
            <form wire:submit.prevent="update">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" wire:model="kapasitas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    <div>
                ...
                <button type="submit" class="my-8 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update Peminjaman</button>
            </form>
        </div>
        @if ($ruangan)
        ...
        @else
        <div class="bg-white col-span p-8 rounded-lg shadow">
            <p class="text-2xl text-red-400 text-center">
                Info Ruangan Tidak Tersedia
            </p>
        </div>
        @endif
    </main>
